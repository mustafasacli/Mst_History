...
namespace Mst.FileCompression
{
    public class FileOperator
    {
        public static void ZipMyFile(string sourceFile, string destinationFile)
        {
            try
            {
                using (FileStream inputStream = File.Open(sourceFile, FileMode.Open), outputStream = new FileStream(destinationFile, FileMode.OpenOrCreate))
                {
