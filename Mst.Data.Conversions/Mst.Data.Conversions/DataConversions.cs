namespace Mst.Data.Conversions
{
    ...
    public class DataConversions
    {
        ...
        #region [ DataTable To Generic List Referenced By Coulmn ]

        public static IList<T> DataTableToListRefByColumn<T>(DataTable datatable) where T : new()
        {
            try
            {
        ...
        #region [ DataTable To Generic List Referenced By Properties ]

        public static IList<T> DataTableToListRefByProperty<T>(DataTable datatable) where T : new()
        {
            try
            {
                List<T> liste = new List<T>();
                ...
                foreach (DataRow row in datatable.Rows)
                {
                    ...
                    {
                        object obj = row[propDesc.Name];
                        if (null != obj && obj != DBNull.Value)
                        {
                            propDesc.SetValue(item, obj);
                        }
                    }
